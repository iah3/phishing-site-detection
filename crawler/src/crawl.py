...
class Crawl:
    ...
    def extract_batches(self, pos, batch_sz):
        CSV_PATH = self.args.data_loc
    ...
    def crawl(self):
        ...
        for i in range(self.start, self.args.num_urls, self.batch_sz):
            ...
            url_strings = self.extract_batches(i, self.batch_sz).tolist()
    ...
    def BFS(self, id, x, root_url):
        ...
        Database.initialize(self.args.database_name, self.args.url_table_name)
...
class UpdateUrl:
    ...
    def update_url_neigbors(self, Url):
        ...
        shuffle(neighbors)
        Url.set_neigbors(neighbors[0:self.args.num_neighbors])
